...
function createProvider(symbol: ts.CallExpression, isArray: boolean, name?: string) {
  ...
  return ts.factory.createArrowFunction(
    ...
    undefined,
    [
      ts.factory.createParameterDeclaration([], undefined, "ctx", undefined,  ts.factory.createTypeReferenceNode('any', []))
    ],
    undefined,
    undefined,
    elmt
...
export function transformer(program: ts.Program/*, opts?:{debug?: boolean}*/) : ts.TransformerFactory<ts.SourceFile> {
